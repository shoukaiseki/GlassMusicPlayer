package com.shoukaiseki.glass.kenny.music;
...
import com.shoukaiseki.glass.kenny.classes.MusicItem;
import com.shoukaiseki.glass.kenny.utils.MemoryCache;
import com.shoukaiseki.glass.kenny.utils.MusicUtil;
...
public class MainService extends Service {
    ...
    public static List<MusicItem> songs, shuffledSongs;
                    ...
                    try {
                        ...
                        if (c != null) {
                            while (c.moveToNext()) {
                                ...
                                Log.d("ms","mi"+com.alibaba.fastjson.JSONObject.toJSONString(mi, SerializerFeature.WriteMapNullValue));
                                songs.add(mi);
                            }
                        }
                        return true;
    ...
    public void nextTrack() {
        ...
        if (shuffled) {
            ...
            Log.d("ms","songIndex="+songIndex+";shuffledSongs="+shuffledSongs.size());
            ...
            if (songIndex + 1 < shuffledSongs.size()) {
                try {
                    ...
                    mediaPlayer.start();
                    render.setTextOfView(shuffledSongs.get(songIndex).getTitle(), shuffledSongs.get(songIndex).getArtist(), null);
                    Log.d("ms","title="+shuffledSongs.get(songIndex).getTitle()+";Artist="+shuffledSongs.get(songIndex).getArtist());
            ...
            Log.d("ms","songIndex="+songIndex+";shuffledSongs="+songs.size());
