package com.shoukaiseki.glass.kenny.utils;
...
public class MusicUtil {
    ...
    public static String getSongTitle(String filePath) {
        try {
            ...
            if(title==null){
                return "file:"+filePath.substring(filePath.lastIndexOf('/')+1);
            }
            if(isEncoding(title,"ISO-8859-1")){
...
//            return "title:"+title;
    ...
    private static boolean isEncoding(String value,String code) throws UnsupportedEncodingException {
